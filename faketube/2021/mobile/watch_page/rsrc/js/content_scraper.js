		...
		.then(html => {
			...
			setTimeout(function() {
				...
				*/
				...
				// to work around this issue, perform a check inside try catch
				try {
				...
				// attempt to get upload year text from 5 types of videos (regular, music, shorts, music - 2nd variant? [topic, no comment section], undefined for now)
				try {
