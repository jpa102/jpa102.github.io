...
if (http.status == 0) {
	...
	global_data.yt.channelLink = "https://jpa102.github.com/faketube/2021/undefined/";
...
setTimeout(function(){
	...
	document.querySelector("#yt-channel-name-link").href = global_data.yt.channelLink; // the link to the youtube channel
