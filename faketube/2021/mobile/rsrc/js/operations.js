			...
			`
				<div id="all-buttons-container" class="exp-all-buttons-container">
					<style id="experimental_material_you_action_buttons" type="text/css">
						...
						.button-text-style { width: 1.5rem; height: 1.5rem; margin-right: 12px; }
						...
						html:not([data-theme-display='light']) .button-border { content: ""; border-left: 1px solid rgba(255, 255, 255, 0.1) !important; }
					</style>
