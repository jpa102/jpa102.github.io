...
if (faketube.config_.EXPERIMENT_FLAGS.watch_page_experimental_material_you_comments_section == false && faketube.config_.EXPERIMENT_FLAGS.watch_page_comment_section_add_arrow_svg == true) {
	setTimeout(function() {
