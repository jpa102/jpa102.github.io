...
if (faketube.config_.EXPERIMENT_FLAGS.video_player_experimental_material_you_action_buttons == true) {
	setTimeout(function() {
			...
			`
				<div id="all-buttons-container" class="exp-all-buttons-container">
					<style id="experimental_material_you_action_buttons" type="text/css">
						:root { --video-player-menu-buttons-text-size: 0.92em; }
						...
						#menu { padding: 6px 16px 8px 16px; }
					...
					<button id="download" class="menu-buttons" onclick="downloadButton()" title="Download this video">
