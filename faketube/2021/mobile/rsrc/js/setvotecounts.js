...
setTimeout(function(){
	// likes
	document.querySelector("#like-count-renderer").innerText = numberFormat(global_data.ryd_data.likeCount);
...
setTimeout(function() {
	document.querySelector("#like-button").ariaLabel="Like this video along with " + global_data.ryd_data.LikesFromRYD + " other people";
