...
const faketube = {
	config_: {
		...
		EXPERIMENT_FLAGS: {
			...
			video_player_experimental_material_you_action_buttons: false, // enable the experimental material you buttons in the action bar
			video_player_experimental_material_you_comments_section: false, // enable the experimental material you comments section in the watch page
