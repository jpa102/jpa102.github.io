...
function _content_scraper(videoId) {
	if (videoId == null) {
	...
	/*
		...
		fetch(`https://www.youtube.com/watch?v=${videoId}&app=desktop`, {
				mode: "cors",
				header: {
	...
	*/
	...
	fetch(`https://www.youtube.com/watch?v=${videoId}&app=desktop`) // use the desktop html for more data with "&app=desktop"
		.then(response => {
