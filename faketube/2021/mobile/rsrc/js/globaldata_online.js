...
var __faketube_aplydbgimdtly = 5100;
var __faketube_aplyfavstebgclr = 301;
var __faketube_sttrdptydwnldr = 5900;
var __faketube_stlkedlkecnts = 5450;
var __faketube_stvwsndte = 5777;
var __faketube_stvtecnts = 5550;
var __faketube_stytchnlifo = 5400;
var __faketube_injtplyr = 900;
...
if (global_data.v == undefined) {
	localStorage.setItem("lastVideoId", "aQvGIIdgFDM"); // store the video id
}

if (global_data.v == "") {
	localStorage.setItem("lastVideoId", "aQvGIIdgFDM"); // store the video id
	global_data.yt.videoId = "aQvGIIdgFDM"; // store the video id
}
