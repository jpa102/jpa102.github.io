...
var global_data = {
	_watch_page_strings: {
		...
		_stored_vars: {
			...
			playback_in_feeds_text_inject: "Playback in feeds",
			playback_in_feeds_desc_text_inject: "Choose whether videos play as you browse",
			playback_in_feeds_alon_text_inject: "Always on",
			playback_in_feeds_wifi_text_inject: "Wi-Fi only",
			playback_in_feeds_off_text_inject: "Off",
