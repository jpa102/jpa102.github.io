...
const faketube = {
	config_: {
		...
		EXPERIMENT_FLAGS: {
			...
			watch_page_collapsed_channel_info: false, // make the channel info collapsed (20.14.xx version and up)
			watch_page_old_2021_action_buttons: false, // replace the 2023 material you style action buttons to that of 2021's action buttons
			watch_page_old_2021_action_buttons_non_delhi_style: false, // replace the 2023 material you style action buttons to that of 2021's action buttons + delhi icons
			watch_page_old_2021_action_buttons_placement: false, // swap the action button and channel metadata to that of 2021's (column-reverse)
			watch_page_old_2021_comments_section: false, // replace the 2023 material you style comments section to that of 2021's comment section in the watch page
			watch_page_old_2021_video_title_font_size: false, // make the font size of the video title smaller and match the look to that of 2021's
			watch_page_smaller_action_button_icons: false, // make the icons inside the action buttons smaller, like in the native youtube app
