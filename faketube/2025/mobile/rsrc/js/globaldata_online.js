...
//	main fetching of return youtube dislike data
try {
	fetch(
...
// safeguard check(s) if the global_data.yt keys doesn't have values in it (result of not proving the video id to v)
if (global_data.yt.videoTitle == "") {  }
