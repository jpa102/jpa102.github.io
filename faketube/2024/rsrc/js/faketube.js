...
const faketube = {
	config_: {
		...
		EXPERIMENT_FLAGS: {
			...
			force_display_ratio_bar: true, // force display the ratio bar under like and dislike buttons
			kevlar_watch_grid: true, // youtube's early 2024 watch grid layout, disliked by many
			...
			web_simplified_action_buttons: true // makes some action buttons look compact (rounded design)
		}
	}
}
