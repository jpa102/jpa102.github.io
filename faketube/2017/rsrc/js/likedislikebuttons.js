...
function likebuttonpressedcheck() {
	if (document.querySelector("#like-button").ariaPressed == "false") {
		...
		document.querySelector("#likebutton-icon > yt-icon > yt-icon-shape > icon-shape > div > svg").remove();
		document.querySelector("#likebutton-icon > yt-icon > yt-icon-shape > icon-shape > div").insertAdjacentHTML(
			"afterbegin",
			`
			<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" style="fill: rgb(72, 152, 214);pointer-events: none; display: block; width: 100%; height: 100%;">
		...
		document.querySelector("#like-count-renderer").style = "color: rgb(72, 152, 214)";
		...
		if (document.querySelector("#dislike-button").ariaPressed == "true") {
			...
			document.querySelector("#dislikebutton-icon > yt-icon > div > icon-shape > div > svg").remove();
			document.querySelector("#dislikebutton-icon > yt-icon > div > icon-shape > div").insertAdjacentHTML(
				"afterbegin",
				`
	...
	if (document.querySelector("#like-button").ariaPressed == "true") {
		...
		document.querySelector("#like-count-renderer").style = "color: black";
