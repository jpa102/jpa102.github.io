...
function likebuttonpressedcheck() {
	if (document.querySelector("#like-button").ariaPressed == "false") {
		...
		document.querySelector("#likebutton-icon > div > svg").remove();
		document.querySelector("#likebutton-icon > div").insertAdjacentHTML(
			"afterbegin",
			`
		...
		if (document.querySelector("#dislike-button").ariaPressed == "true") {
			...
			document.querySelector("#dislikebutton-icon > div > svg").remove();
			document.querySelector("#dislikebutton-icon > div").insertAdjacentHTML(
				"afterbegin",
				`
