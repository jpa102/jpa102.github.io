...
function descriptionButton() {
	...
	if (document.querySelector("#expand-description-button").ariaPressed == "false") {
		...
		document.querySelector("#expand-description-button").title = "Collapse the description box"
	...
	if (document.querySelector("#expand-description-button").ariaPressed == "true") {
		...
		document.querySelector("#expand-description-button").title = "Expand the description box"
