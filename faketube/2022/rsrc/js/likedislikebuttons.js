...
setTimeout(function() {
	document.querySelector("#like-button").ariaLabel="Like this video along with " + likes + " other people";
	document.querySelector("#dislike-button").ariaLabel="Dislike this video along with " + dislikes + " other people";
}, 1000);
